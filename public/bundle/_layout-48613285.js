...
/* src\pages\example\nesting\_layout.svelte generated by Svelte v3.16.4 */
const file = "src\\pages\\example\\nesting\\_layout.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (!current || dirty[0] & /*$url*/ 1 && a_href_value !== (a_href_value = /*$url*/ ctx[0]("./child"))) {
...
//# sourceMappingURL=_layout-48613285.js.map
